...
if [ $channel_id == "kumachannel" ]; then
  ...
  channel_orderer_org=org.kunstmaan.be

  wait_for_host kumapeer.org.kunstmaan.be
  wait_for_host authpeer.auth.kunstmaan.be

  create_channel kumapeer org.kunstmaan.be $channel_orderer $channel_orderer_org $channel_id
  join_channel kumapeer org.kunstmaan.be $channel_orderer $channel_orderer_org $channel_id
